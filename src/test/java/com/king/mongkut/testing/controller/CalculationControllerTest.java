...
class CalculationControllerTest {
    ...
    // add in classroom
    @Test
    void should_return_status_ok_when_call_minus_given_number1_and_number2() {
        //Given
        String number1="10";
        String number2="5";
        when(calculationService.minus(number1,number2)).thenReturn(5);

        //When
        ResponseEntity<?> actual = calculationController.minus(number1,number2);
    ...
    @Test
    void should_return_bad_req_when_call_minus_given_minus_one_from_service() {
        //Given
        when(calculationService.minus("X","5")).thenReturn(-1);
    ...
    void should_return_status_ok_when_call_multiply_give_number1_and_number2() {
        // Given
        when(calculationService.multiply("10", "5")).thenReturn(50);

        // When
        ResponseEntity<?> actual = calculationController.multiply("10", "5");

        // Then
        assertEquals(HttpStatus.OK, actual.getStatusCode());
        assertAll("should return success status",
                () -> assertEquals(50, actual.getBody())
        );
    }
    ...
    //devide
    @Test
    void should_return_status_ok_when_call_devide_give_number1_and_number2() {
        // Given
        when(calculationService.devide("10", "5")).thenReturn(2);

        // When
        ResponseEntity<?> actual = calculationController.devide("10", "5");
    ...
    @Test
    void should_return_bad_req_when_call_multiply_given_minus_one_from_service() {
        //Given
        when(calculationService.multiply("X","5")).thenReturn(-1);

        //When
        ResponseEntity<?> actual = calculationController.multiply("X","5");
    ...
    //Focus contrroller test controller , can't test service (mock,inject)
//    @Test
//    void should_return_number_when_call_minus_number1_and_number2(){
//        //Given
//
//
//        //When
